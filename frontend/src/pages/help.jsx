...
export default function Help() {
  const [lang] = useLang();
  const t = T[lang]?.help || T.en.help; // Fallback to English if translation is missing
              ...
              <div className="d-flex justify-content-center">
                <div style={{ width: "100%", maxWidth: "900px" }}>
                  <div className="ratio ratio-16x9">
                    <iframe
                      src="https://www.youtube.com/embed/ZZ2LdwSIaFg"
                      title="SmartSubmit Tutorial"
